...
Output: one JSON per Taboo cell at ${PATH_TO_FOLDER}/results/taboo_behavioral/<cell>.json
"""
...
OUT_DIR = os.path.expandvars("${PATH_TO_FOLDER}/results/taboo_behavioral")
os.makedirs(OUT_DIR, exist_ok=True)

PROMPTS_DIR = os.path.expandvars("${PATH_TO_FOLDER}/activation_oracles/datasets/taboo")
...
KARVONEN_ROOT = os.path.expandvars("${PATH_TO_FOLDER}/results/ao_taboo_karvonen_q8")
STRICT_ROOT = os.path.expandvars("${PATH_TO_FOLDER}/results/ao_taboo_strict_q8")
