"""FT-AO training: like sft_qwen3_1p7B_ftao_inner.py but applies + merges a target LoRA
...
_baseline = "/gpfs/scratch/USER/activation_oracles/nl_probes/sft_qwen3_1p7B_ftao_inner.py"
